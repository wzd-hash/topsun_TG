...
public interface TimerTaskService {
	...
	void insertOutLine(List<DataLocation> result);

	List<Outline> getOutLine(Map<String, Object> map);

	void insertAlarmStatistics(List<AlarmStatistics> list);
	...
	List<DataLocation> getHistoryByBusID(String tableName, Integer busID, String time);

	void insertOfflineDisplacement(List<OfflineDisplacement> result);

	Outline listLatestOutLineLog(String string);
